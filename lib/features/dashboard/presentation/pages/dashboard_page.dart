...
import '../../../school/presentation/pages/result_entry_page.dart';
import '../../../school/presentation/pages/manage_grading_rules_page.dart';
        ...
        return Scaffold(
            ...
            actions: [
              ...
              BlocBuilder<StaffBloc, StaffState>(
                builder: (context, staffState) {
                  if (staffState.currentUser != null) {
                    return Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(staffState.currentUser!.name, 
                              style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                            Text(staffState.currentUser!.role, 
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            context.read<StaffBloc>().add(LogoutStaff());
          ...
          body: BlocBuilder<StaffBloc, StaffState>(
            builder: (context, staffState) {
              ...
              final isAdmin = staffState.currentUser?.role == 'Admin';
                ...
                children: [
                  ...
                  if (isSchool) ...[
                    _buildMenuCard(
                      ...
                      Icons.edit_note,
                      Colors.indigo,
                      () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ResultEntryPage())),
                    ),
                    if (isAdmin)
                      _buildMenuCard(
                        context,
                        ...
                        Icons.rule,
                        Colors.brown,
                        () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ManageGradingRulesPage())),
                      ),
                  ],
                ],
              );
