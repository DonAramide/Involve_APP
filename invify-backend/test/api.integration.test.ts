...
describe('UAT-API-03 | RBAC — Protected Routes Are Registered', () => {
  ...
  const protectedRoutes = [
    ...
    { method: 'get', path: '/api/admin/tenant-payables', label: 'Admin Tenant Payables' },
    { method: 'get', path: '/api/admin/virtual-accounts', label: 'Admin Virtual Accounts' },
    ...
    { method: 'get', path: '/api/finance/school-dashboard', label: 'School Finance Dashboard' },
