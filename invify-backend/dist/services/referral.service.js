...
exports.ReferralNotificationService = exports.ReferralService = void 0;
...
class ReferralService {
     ...
     */
    static async trackSignup(newTenantId, adminEmail, referralCode) {
        try {
            // 1. Fetch Referrer
            ...
            const { data: referrerAdmin } = await supabase_1.supabase
                .from('users')
                .select('email')
     ...
     */
    static async applyReward(newTenantId) {
        try {
            // 1. Find Referrer
            ...
            await supabase_1.supabase.rpc('increment_bonus_quota', {
...
class ReferralNotificationService {
    static async sendInvite(fromSchool, toEmail, referralLink) {
        console.log(`
      --------------------------------------------------
...
exports.ReferralNotificationService = ReferralNotificationService;
