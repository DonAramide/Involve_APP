...
exports.ImmutableAuditChain = void 0;
...
class ImmutableAuditChain {
     ...
     */
    static _tamperForTesting(seq, newData) {
        const record = this.chain.find((r) => r.seq === seq);
        if (record) {
            record.data = newData;
            // Corrupt the stored hash — the next record's prevHash will no longer match
            record.hash = 'CORRUPTED_HASH_XXXXXXXXXXX';
        }
    }
}
exports.ImmutableAuditChain = ImmutableAuditChain;
//# sourceMappingURL=ImmutableAuditChain.js.map