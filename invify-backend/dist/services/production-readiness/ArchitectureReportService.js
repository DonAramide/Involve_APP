...
exports.ArchitectureReportService = void 0;
...
class ArchitectureReportService {
    static generate() {
        ...
        const overallStatus = certifiedLayers === ARCHITECTURE_LAYERS.length
            ? 'CERTIFIED' : 'DEGRADED';
        const serviceCount = ARCHITECTURE_LAYERS.reduce((sum, l) => sum + l.services.length, 0);
        return {
            reportId: `ARCH-${Date.now()}`,
            generatedAt: new Date().toISOString(),
            title: 'Invify Banking Platform — Architecture Certification Report',
            description: 'End-to-end architecture audit of all Phase 3 banking infrastructure services ' +
...
exports.ArchitectureReportService = ArchitectureReportService;
//# sourceMappingURL=ArchitectureReportService.js.map