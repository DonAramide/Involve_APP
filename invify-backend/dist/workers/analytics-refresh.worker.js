...
exports.analyticsRefreshWorker = exports.AnalyticsRefreshWorker = void 0;
const supabase_1 = require("../db/supabase");
class AnalyticsRefreshWorker {
    isRunning = false;
    intervalId;
    start() {
        if (this.intervalId)
    ...
    async processQueue() {
        ...
        try {
            ...
            const { data: queueItems, error: queueError } = await supabase_1.supabaseAdmin
            ...
            const { error: rpcError } = await supabase_1.supabaseAdmin.rpc('refresh_analytics_mvs');
    ...
    async logRefreshResult(status, durationMs, errorMessage) {
        try {
            const { error } = await supabase_1.supabaseAdmin.from('analytics_refresh_log').insert({
                status,
...
exports.AnalyticsRefreshWorker = AnalyticsRefreshWorker;
// Singleton instance
exports.analyticsRefreshWorker = new AnalyticsRefreshWorker();
//# sourceMappingURL=analytics-refresh.worker.js.map