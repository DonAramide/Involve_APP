...
class LicenseGenerator {
    static hmacSecret = 'INVOLVE-SECURE-HMAC-SECRET-2024';
    static encodeSuffix(suffix) {
        if (!suffix)
            return 0;
        let hash = 5381n;
    ...
    static generateBusinessHash(name) {
    ...
    static generate(businessName, durationDays, planIndex, deviceSuffix) {
