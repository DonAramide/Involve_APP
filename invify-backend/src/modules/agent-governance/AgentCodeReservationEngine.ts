export class AgentCodeReservationEngine {
  private readonly reservedNamespaces = ['AAA', 'INV', 'SYS', 'ADM', 'ROT']; // ROOT** is 4 chars, using ROT for 3 char prefix
  ...
  public isReservedNamespace(code: string): boolean {
  ...
  public validateCodeFormat(code: string): boolean {
