...
function applySecretAliases() {
  const copies: Array<[string, string]> = [
    ...
    ['STAGING_QUASAR_WEBHOOK_SECRET', 'QUASAR_WEBHOOK_SECRET'],
    ['QUASAR_WEBHOOK_SIGNING_SECRET', 'QUASAR_WEBHOOK_SECRET'],
    ['QUASAR_WEBHOOK_SECRET', 'QUASAR_WEBHOOK_SIGNING_SECRET'],
    ['STAGING_QUASAR_API_KEY', 'QUASAR_API_KEY'],
