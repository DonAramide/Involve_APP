...
async function run() {
  console.log('=== RUNNING PHASE 1B ROLLBACK (Pooler) ===\n');
  ...
  try {
    const sqlPath = 'C:/Users/IIPS/.gemini/antigravity/brain/f6abfa43-41a3-4b4e-8428-774175a2199e/staging_ledger_rollback.sql';
    console.log(`Reading SQL from: ${sqlPath}`);
    const sql = fs.readFileSync(sqlPath, 'utf-8');

    console.log('Executing Rollback DDL SQL statements...');
