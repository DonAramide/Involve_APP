...
/**
 * https://github.com/phanirajabhandari/android-keystore-example/blob/master/app/src/main/java/com/example/keystore/EncryptionUtils.java
 */
public class KeystoreEncryptionUtils {
