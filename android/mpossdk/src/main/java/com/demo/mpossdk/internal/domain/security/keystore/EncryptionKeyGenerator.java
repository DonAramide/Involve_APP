package com.demo.mpossdk.internal.domain.security.keystore;
...
/**
 * https://github.com/phanirajabhandari/android-keystore-example/blob/master/app/src/main/java/com/example/keystore/EncryptionKeyGenerator.java
 */
public class EncryptionKeyGenerator {
    ...
    static SecurityKey generateSecretKeyPre18(Context context) {
        ...
        try {
            ...
            LogUtil.INSTANCE.d("Secret Key Fetched :" + new String(pkEntry.getSecretKey().getEncoded(), "UTF-8"));
    ...
    private static void saveMyKeystore(Context context, KeyStore androidCAStore, char[] password,
        ...
        LogUtil.INSTANCE.d("Secret Key Saved : " + new String(mySecretKey.getEncoded(), "UTF-8"));
    }
}
