...
/**
 * Packager matching Accelerex/mpos IsoPackager (C:\\dev\\mpos):
 * PIN (52) and MAC (64/128) are binary — ASCII IF_CHAR packing causes host parse
 * failure and peer-disconnect on purchase.
 */
public class MposIsoPackager extends ISOBasePackager {

    public MposIsoPackager() {
        ISOFieldPackager[] fld = new ISOFieldPackager[]{
                ...
                new IFA_NUMERIC(3, "NETWORK INTERNATIONAL IDENTIFIER"),
                ...
                new IFA_LLNUM(11, "ACQUIRING INSTITUTION IDENTITY CODE"),
                new IFA_LLNUM(11, "FORWARDING INSTITUTION IDENTITY CODE"),
                ...
                new IFA_LLCHAR(25, "ADDITIONAL RESPONSE DATA"),
                new IFA_LLCHAR(76, "TRACK 1 DATA"),
                new IFA_LLLCHAR(999, "ADDITIONAL DATA - ISO"),
                new IFA_LLLCHAR(999, "ADDITIONAL DATA - NATIONAL"),
                ...
                new IFA_BINARY(48, "SECURITY RELATED CONTROL INFORMATION"),
                ...
                new IFA_LLLCHAR(999, "RESERVED PRIVATE"),
                new IFA_LLLCHAR(999, "RESERVED PRIVATE"),
                new IFA_LLLLCHAR(9999, "RESERVED PRIVATE"),
                new IFA_BINARY(32, "MESSAGE AUTHENTICATION CODE FIELD"),
                new IFA_BINARY(16, "BITMAP, EXTENDED"),
                ...
                new IFA_LLNUM(11, "SETTLEMENT INSTITUTION IDENTITY CODE"),
                new IFA_LLNUM(11, "RECEIVING INSTITUTION IDENTITY CODE"),
